  ...
  return (
    <div className="About-us" id="About-us" lang="ar">
      ...
      <div className="About-us-Header Page-Header">
        ...
        <div className="Page-Title-Wrapper"><h2 className="Page-Title">  من نحن  </h2></div>
      ...
      <div className="About-us-Body Page-Body">
        ...
        <section className="About-us-content A-one">
          ...
          <div className="About-us-description">
            <div className="description-wrapper">
              <p>             
              نحن فريق من الخبراء المتخصصين في تقديم حلول تقنية المعلومات المبتكرة والأدوات الذكية لعملائنا. نتميز في مجال تقنية المعلومات، حيث نلعب دورًا أساسيًا في تطوير الأعمال وتعزيز الإنتاجية، مواكبين لأحدث التطورات وتقنيات الذكاء الاصطناعي التي تسرع من وتيرة تحقيق النجاح المستدام  لأعمالكم و لمشاريعكم و تساعد تكنولوجيا الذكاء الاصطناعي لدينا إلى تحسين أداء الشركات والأعمال التجارية بكفاءة لتحقيق الجودة و، معالجة التحديات التقليدية في بيئة العمل بسلاسة، ونحن نعتمد على أحدث التقنيات والأدوات في مجال تقنية المعلومات والذكاء الاصطناعي لخدمتكم، مما يساعد في تطوير وأتمتة العمليات وتحسين أداء الشركات والمؤسسات. نقدم حلولًا تسهم في توزيع ورقابة المهام اليومية للأفراد والموظفين، وتفاصيل العمليات اليومية للأعمال. برمجياتنا مصممة لخدمة وتطوير مختلف المجالات مثل الطب، الإدارة، المصارف، التعليم، والخدمات المنزلية وغيرها. 
        ...
        <section className="About-us-content A-two">
          ...
          <div className="About-us-description">
            <p> تخصصنا في مجال تقنية المعلومات يلعب دورًا حيويًا في تطوير الأعمال وتحسين الإنتاجية و مواكبة التطور الحديث و تقنيات الذكاء الاصطناعي التي تساعد في سرعة تحقيق النجاح المستدام لأعمالك .
            و نعتمد علي أحدث تقنيات و الأدوات من عالم تقنية المعلومات والذكاء الاصطناعي لخدمتك و التي تساعدك في التطوير و أتمتة العمليات وتحسين أداء الشركات و المؤسسات لتوزيع و رقابة مهام الأفراد والموظفين اليومية و تفاصيل العمليات اليومية للأعمال.
          ...
          <div className="left-section-ab" ref={leftSectionRef2}>
            <img src={require('../../Assets/Images/IT-gif.gif')} alt="About 2" />
          </div>
        ...
        <section className="About-us-content A-three">
          <div className="left-section-ab" ref={leftSectionRef3}>
            <img src={require('../../Assets/Images/marketing-gif.gif')} alt="About 3" />
          </div>
